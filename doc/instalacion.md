...
`# wget https://github.com/Kedap/apmpkg/releases/download/1.0.2/apmpkg-1.0.1_amd64.deb; apt install ./apmpkg-1.0.2_amd64.deb`
...
`wget https://github.com/Kedap/apmpkg/releases/download/1.0.1/apmpkg-1.0.2-1-x86_64.pkg.tar.zst; pacman -U apmpkg-1.0.1-1-x86_64.pkg.tar.zst`
...
`apmpkg instalar -u https://github.com/Kedap/apmpkg/releases/download/1.0.1/apmpkg-1.0.2.abi.tar.gz`
